...
def create_Voronoi_label(data_dir, save_dir, train_list):
    ...
    for img_name in tqdm(train_list):
        ...
        misc.imsave('{:s}/{:s}_label_vor.png'.format(save_dir, name), label_vor)
...
def create_cluster_label(data_dir, label_point_dir, label_vor_dir, save_dir, train_list):
    ...
    for img_name in tqdm(train_list):
        ...
        ori_image = misc.imread('{:s}/{:s}.png'.format(data_dir, name))
        h, w, _ = ori_image.shape
        label_point = misc.imread('{:s}/{:s}_label_point.png'.format(label_point_dir, name))
        ...
        label_vor = misc.imread('{:s}/{:s}_label_vor.png'.format(label_vor_dir, name))
        ...
        misc.imsave('{:s}/{:s}_label_cluster.png'.format(save_dir, name), refined_label)
